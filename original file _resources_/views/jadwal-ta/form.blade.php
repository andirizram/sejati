...
<div class="row mb-3">
    <div class="col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control @error('dosen_penguji_1') is-invalid @enderror" name="dosen_penguji_1"
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control @error('dosen_penguji_2') is-invalid @enderror" name="dosen_penguji_2"
