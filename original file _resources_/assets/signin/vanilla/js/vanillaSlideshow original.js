...
var vanillaSlideshow = (function () {
    ...
    app.init = function (options) {
        ...
        if (options && typeof options === "object") {
            defaults.arrows = (options.arrows !== '') ? options.arrows : defaults.arrows;
            defaults.indicators = (options.indicators !== '') ? options.indicators : defaults.indicators;
            defaults.random = (options.random !== '') ? options.random : defaults.random;
            defaults.slideshow = (options.slideshow !== '') ? options.slideshow : defaults.slideshow;
            defaults.delay = (options.delay) ? options.delay : defaults.delay;
            defaults.animationSpeed = (options.animationSpeed) ? options.animationSpeed : defaults.animationSpeed;
        }
