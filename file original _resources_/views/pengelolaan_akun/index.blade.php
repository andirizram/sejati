    ...
    @can('role.index')
        <section>
            ...
            <table class="table table-bordered table-striped" id="table-role">
                <p>Menyajikan informasi tentang berbagai jenis akun yang tersedia, termasuk hak akses dan fitur
...
@section('script')
    ...
    <script type="module">
        $(document).ready(function () {
            ...
            $('#table-user').dataTable(tableProps);

            $('#table-role').dataTable(tableProps)
