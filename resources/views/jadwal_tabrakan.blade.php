...
@section('content')
                        ...
                        @foreach($jadwals as $jadwal)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        {!! $jadwal['detail_jadwal']['deskripsi'] !!}
                                    @endif
                                </td>
                            </tr>
                        @endforeach
    ...
    <!-- Modals for different schedule types -->
    @foreach(['ta', 'prodi', 'tpb', 'lain'] as $type)
        <x-modal-jadwal
            :id="'modal-' . $type"
            :method="'POST'"
            :action="route('jadwal-' . $type . '.store')">
            @include('jadwal-' . $type . '.form')
        </x-modal-jadwal>
    @endforeach
@endsection
