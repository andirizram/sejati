...
class PermissionHelper
{
    const LANG_PERMISSIONS = [
        ...
        'jadwal-ta.store' => 'Menyimpan jadwal TA',
        ...
        'jadwal-tpb.store' => 'Menyimpan jadwal TPB',
        ...
        'jadwal-prodi.store' => 'Menyimpan jadwal Prodi',
        ...
        'jadwal-lain.store' => 'Menyimpan jadwal Lainnya',
        ...
        'pengaturan.update' => 'Mengupdate pengaturan sistem',
        'pengaturan.clear-data' => 'Menghapus semua jadwal yang ada pada sistem',
